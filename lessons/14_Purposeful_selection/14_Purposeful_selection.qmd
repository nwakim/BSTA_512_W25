...
::: columns
::: column 
![](13_Purposeful_selection/spline1.png){fig-align="center"}
:::

::: column 
![](13_Purposeful_selection/spline2.png){fig-align="center"}
:::
:::
...
## Step 5: Check for interactions {.smaller}
...
```{r}
#| echo: false
MLRs[[1]] %>% tidy() %>%  gt() %>% tab_options(table.font.size = 33) %>% fmt_number(decimals = 3)
```
:::
:::
